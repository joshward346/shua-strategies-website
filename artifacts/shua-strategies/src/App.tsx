...
function Mcat() {
  ...
  return <Shell><main>
    ...
    <section className="section section-soft"><div className="container-wide"><div className="reveal" style={{ maxWidth: 700 }}><p className="manifesto">I’ll help build the roadmap.<br />You still have to drive.</p><p className="section-intro">You’ll have a clear plan, thoughtful instruction, consistent accountability, and detailed review. When your performance tells us something needs to change, we change it.</p><p className="section-intro">This is a working relationship. My job is to make sure the work has direction.</p></div></div></section>
